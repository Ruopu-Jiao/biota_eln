      ...
      <div className="space-y-4">
        <form action={registerAction} className="space-y-4">
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300">
            ...
            />
            <span>
              I understand this is an early-access workspace and that
              organization sharing, protocols, entities, and sequence tools
        ...
        <DemoModePanel
          title="Skip setup in local demo mode"
          description="If you are only checking the UI and do not have a database configured yet, jump straight into the demo workspace instead of creating a real account."
